...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, addTodolist.fulfilled({todolist: newTodolist}, 'requestId', newTodolistTitle));
...
test('correct filter of todolist should be changed', () => {
    ...
    const endState = todolistsReducer(startState, changeFilter({value: newFilter, todolistId: todolistId2}));
